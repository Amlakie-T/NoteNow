...
import com.notenow.app.presentation.screens.settings.widgets.CustomListDialog
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (settings.settings.value.passcode.isNullOrBlank()) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.notenow.app.presentation.navigation.ActionType.PASSCODE))
                    } else {
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (!settings.settings.value.fingerprint) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.notenow.app.presentation.navigation.ActionType.FINGERPRINT))
                    } else {
            ...
            createSettingBox(
                ...
                onAction = {
                    ...
                    if (settings.settings.value.pattern.isNullOrBlank()) {
                        navController.navigate(NavRoutes.LockScreen.createRoute(com.notenow.app.presentation.navigation.ActionType.PATTERN))
                    } else {
